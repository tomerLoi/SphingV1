...
"""
Django settings for sphingv1_project project.
...
SECRET_KEY = 'django-insecure-1q!yqniauks_0uabzm%^h&=!awzin6*r-d((7e$$@(nym!1xa7'
...
ROOT_URLCONF = 'sphingv1_project.urls'
...
WSGI_APPLICATION = 'sphingv1_project.wsgi.application'
